    ...
    return (
          <Grid  container direction='column' justify='center' alignItems='center'>
              <Grid  container spacing={4} direction='row' justify='center' alignItems='center' style={{padding: "10px 10px 10px 10px"}}>
                <Grid item>
                  <button  style={{height: buttonStyleHeight, width: buttonStyleWidth, color: 'white', background: 'none', alignItems:"center"}} onClick={answerQuestion} value={props.questions[0]} >
                    <ResponsiveImage src={props.images[0]} width={300} height={300}/>
                  </button>
                </Grid>
                <Grid item>
                <button  style={{height: buttonStyleHeight, width: buttonStyleWidth, color: 'white', background: 'none', alignItems:"center"}} onClick={answerQuestion} value={props.questions[1]} >
              ...
              <Grid  container spacing={4} direction='row' justify='center' alignItems='center' style={{padding: "20px 20px 20px 20px"}}>
                <Grid item>
                <button  style={{height: buttonStyleHeight, width: buttonStyleWidth, color: 'white', background: 'none', alignItems:"center"}} onClick={answerQuestion} value={props.questions[2]} >
                  <ResponsiveImage src={props.images[2]} width={300} height={300}/>
                </button>
                </Grid>
                <Grid item>
                <button  style={{height: buttonStyleHeight, width: buttonStyleWidth, color: 'white', background: 'none', alignItems:"center"}} onClick={answerQuestion} value={props.questions[3]} >
